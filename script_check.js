...
/* ═══════════════════════════════════════════════════
   ADMINISTRACIÓN BASE V7 — Panel ejecutivo, directorios separados y creación única
   Regla de oro: no se mezclan inmobiliarias, independientes y grupos.
═══════════════════════════════════════════════════ */
const ADMIN_V7_STORAGE_KEY = 'neri_admin_base_v7_panel_ejecutivo';
const ADMIN_V7_PLANES_INMOBILIARIA = [
...
const ADMIN_V7_PLANES = {
  independiente:'Independiente · 1 asesor',
  grupo:'Grupo sin inmobiliaria · 5 asesores'
};
function adminV7Css(){ return `<style id="admin-v7-style">
  .admin-v7-body{padding:0;overflow-y:auto;background:radial-gradient(circle at top right,rgba(201,169,110,.065),transparent 30%),#080808}
  .admin-v7-wrap{padding:28px;max-width:1540px;margin:0 auto}
  .admin-v7-hero{border:1px solid var(--goldbdr);background:linear-gradient(135deg,rgba(201,169,110,.11),rgba(255,255,255,.018) 42%,rgba(0,0,0,.12));border-radius:4px;padding:26px;position:relative;overflow:hidden}
  .admin-v7-hero:after{content:'NERI';position:absolute;right:-18px;bottom:-34px;font-family:var(--display);font-size:126px;letter-spacing:8px;color:rgba(201,169,110,.04);pointer-events:none}
  .admin-v7-top{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;position:relative;z-index:1;flex-wrap:wrap}
  .admin-v7-title{font-family:var(--display);font-size:48px;letter-spacing:3px;line-height:.92;color:#fff}.admin-v7-title em{color:var(--gold);font-style:normal}
  .admin-v7-sub{font-size:12px;color:var(--w50);line-height:1.75;max-width:780px;margin-top:10px}
  .admin-v7-create{border:1px solid var(--gold);background:linear-gradient(180deg,#e2c88d,#c9a96e);color:#050505;border-radius:3px;padding:15px 22px;font-size:9px;letter-spacing:2.8px;text-transform:uppercase;font-weight:900;cursor:pointer;box-shadow:0 18px 42px rgba(201,169,110,.12);transition:transform .15s,filter .15s;min-width:230px}.admin-v7-create:hover{filter:brightness(1.08);transform:translateY(-1px)}
  .admin-v7-kpis{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-top:22px;position:relative;z-index:1}.admin-v7-kpi{border:1px solid var(--border);background:rgba(0,0,0,.24);padding:16px;border-radius:3px}.admin-v7-kpi-num{font-family:var(--display);font-size:42px;line-height:1;color:var(--gold);letter-spacing:2px}.admin-v7-kpi-lbl{font-size:8px;letter-spacing:2px;text-transform:uppercase;color:var(--w50);font-weight:800;margin-top:7px;line-height:1.5}
  .admin-v7-alerts{margin-top:14px;display:flex;gap:8px;flex-wrap:wrap}.admin-v7-alert{border:1px solid rgba(251,191,36,.22);background:rgba(251,191,36,.06);color:#fbbf24;border-radius:999px;padding:7px 12px;font-size:8px;letter-spacing:1.5px;text-transform:uppercase;font-weight:800}.admin-v7-alert.red{border-color:rgba(248,113,113,.24);background:rgba(248,113,113,.06);color:var(--red)}
  .admin-v7-nav{display:flex;gap:8px;flex-wrap:wrap;margin:20px 0 22px}.admin-v7-nav button{border:1px solid var(--border2);background:rgba(255,255,255,.025);color:var(--w50);border-radius:999px;padding:9px 14px;font-size:8px;letter-spacing:2px;text-transform:uppercase;font-weight:900;cursor:pointer}.admin-v7-nav button.active,.admin-v7-nav button:hover{border-color:var(--goldbdr);background:var(--golddim);color:var(--gold)}
  .admin-v7-section{margin-top:18px}.admin-v7-sec-head{display:flex;justify-content:space-between;align-items:flex-end;gap:12px;flex-wrap:wrap;margin-bottom:12px}.admin-v7-sec-title{font-family:var(--display);font-size:31px;letter-spacing:2px;line-height:1}.admin-v7-sec-title em{color:var(--gold);font-style:normal}.admin-v7-sec-sub{font-size:10px;color:var(--w40);letter-spacing:1.4px;text-transform:uppercase;margin-top:5px}
  .admin-v7-packages{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.admin-v7-package{border:1px solid var(--border);background:linear-gradient(180deg,var(--surface2),var(--surface));padding:17px;border-radius:3px}.admin-v7-package b{font-family:var(--display);font-size:24px;letter-spacing:1.6px}.admin-v7-package span{display:block;color:var(--w50);font-size:10px;line-height:1.7;margin-top:7px}.admin-v7-package small{display:inline-block;margin-top:12px;color:var(--gold);font-size:7px;letter-spacing:1.5px;text-transform:uppercase;font-weight:900}
  .admin-v7-directory-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.admin-v7-dir-card{border:1px solid var(--border);background:linear-gradient(180deg,var(--surface2),var(--surface));border-radius:3px;padding:18px;cursor:pointer;transition:all .15s}.admin-v7-dir-card:hover{border-color:var(--goldbdr);background:var(--golddim);transform:translateY(-1px)}.admin-v7-dir-card .num{font-family:var(--display);font-size:46px;color:var(--gold);line-height:1}.admin-v7-dir-card .name{font-size:12px;font-weight:900;letter-spacing:.3px;margin-top:6px}.admin-v7-dir-card .desc{font-size:10px;color:var(--w50);line-height:1.6;margin-top:7px}
  .admin-v7-list{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}.admin-v7-account-card{border:1px solid var(--border);background:linear-gradient(180deg,var(--surface2),var(--surface));border-radius:3px;padding:16px;cursor:pointer;transition:all .14s;position:relative}.admin-v7-account-card:hover{border-color:var(--goldbdr);background:rgba(201,169,110,.045)}.admin-v7-account-card:before{content:'';position:absolute;left:0;top:0;bottom:0;width:2px;background:var(--gold);opacity:.45}.admin-v7-account-name{font-size:15px;font-weight:900;line-height:1.3}.admin-v7-account-meta{font-size:10px;color:var(--w50);line-height:1.65;margin-top:8px}.admin-v7-account-actions{display:flex;justify-content:space-between;align-items:center;gap:10px;margin-top:13px}.admin-v7-resolver{font-size:8px;letter-spacing:2px;text-transform:uppercase;color:var(--gold);font-weight:900}
  .admin-v7-empty{border:1px dashed var(--border2);background:rgba(255,255,255,.018);border-radius:3px;padding:42px 20px;text-align:center;color:var(--w40);font-size:12px;line-height:1.8}.admin-v7-empty b{color:var(--gold);display:block;font-family:var(--display);font-size:30px;letter-spacing:2px;margin-bottom:6px}
  .admin-v7-detail-grid{display:grid;grid-template-columns:420px 1fr;gap:16px;align-items:start}.admin-v7-side{display:flex;flex-direction:column;gap:12px}.admin-v7-card{border:1px solid var(--border);background:linear-gradient(180deg,var(--surface2),var(--surface));border-radius:3px;overflow:hidden}.admin-v7-card-head{padding:17px;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.admin-v7-card-title{font-family:var(--display);font-size:25px;letter-spacing:1.7px}.admin-v7-card-title em{font-style:normal;color:var(--gold)}.admin-v7-card-body{padding:17px}.admin-v7-mini-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.admin-v7-mini{border:1px solid var(--border);background:rgba(255,255,255,.02);padding:12px;border-radius:3px}.admin-v7-mini kbd{display:block;font-size:7px;letter-spacing:1.5px;text-transform:uppercase;color:var(--w30);font-weight:900;margin-bottom:6px}.admin-v7-mini strong{font-size:14px;color:#fff}.admin-v7-mini strong.gold{color:var(--gold)}
  .admin-v7-users{display:flex;flex-direction:column;gap:8px}.admin-v7-user-row{border:1px solid var(--border);background:rgba(255,255,255,.02);padding:11px;border-radius:3px;display:grid;grid-template-columns:1fr auto;gap:10px;align-items:center}.admin-v7-user-name{font-size:12px;font-weight:900}.admin-v7-user-meta{font-size:9px;color:var(--w50);line-height:1.6;margin-top:4px}.admin-v7-user-actions{display:flex;gap:6px;flex-wrap:wrap;justify-content:flex-end}.admin-v7-smallbtn{border:1px solid var(--border2);background:transparent;color:var(--w50);border-radius:2px;padding:6px 9px;font-size:7px;letter-spacing:1.4px;text-transform:uppercase;font-weight:900;cursor:pointer}.admin-v7-smallbtn:hover{border-color:var(--goldbdr);color:var(--gold);background:var(--golddim)}.admin-v7-smallbtn.red:hover{border-color:rgba(248,113,113,.25);background:rgba(248,113,113,.06);color:var(--red)}
  .admin-v7-create-types{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.admin-v7-type-card{border:1px solid var(--border);background:linear-gradient(180deg,var(--surface2),var(--surface));border-radius:3px;padding:22px;cursor:pointer;min-height:180px;transition:all .15s}.admin-v7-type-card:hover{border-color:var(--goldbdr);background:var(--golddim);transform:translateY(-1px)}.admin-v7-type-card .icon{font-size:28px;color:var(--gold);margin-bottom:14px}.admin-v7-type-card b{font-family:var(--display);font-size:28px;letter-spacing:1.6px;line-height:1}.admin-v7-type-card p{font-size:11px;color:var(--w50);line-height:1.7;margin-top:10px}
  .admin-v7-support-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.admin-v7-support{border:1px solid var(--border);background:rgba(255,255,255,.02);border-radius:3px;padding:12px;font-size:10px;color:var(--w50);line-height:1.55}.admin-v7-support b{display:block;color:var(--white);font-size:11px;margin-bottom:4px}
  .admin-v7-form-note{padding:12px 14px;background:var(--golddim);border:1px solid var(--goldbdr);border-left:3px solid var(--gold);font-size:10px;color:var(--w50);line-height:1.7;margin-bottom:14px}
  ...
  @media(max-width:1100px){.admin-v7-kpis,.admin-v7-packages,.admin-v7-directory-grid,.admin-v7-create-types,.admin-v7-support-grid{grid-template-columns:1fr 1fr}.admin-v7-detail-grid,.admin-v7-list{grid-template-columns:1fr}}
  @media(max-width:700px){.admin-v7-wrap{padding:18px}.admin-v7-kpis,.admin-v7-packages,.admin-v7-directory-grid,.admin-v7-create-types,.admin-v7-support-grid{grid-template-columns:1fr}.admin-v7-title{font-size:38px}.admin-v7-create{width:100%}}
</style>`; }

function adminSeedData(){
  return {
    cuentas:[
      { id:'cta-c21-haus-v7', nombre:'Century 21 Haus · Cuernavaca', tipo:'Inmobiliaria', estado:'Activo', ciudad:'Cuernavaca', responsable:'Dirección comercial', director:'Director pendiente', whatsappDirector:'', emailDirector:'', logo:'', limiteAsesores:10, plan:'Inmobiliaria 10 asesores', notas:'Cuenta inmobiliaria de prueba. Aquí se controla estado, cupo, branding y soporte.' },
      { id:'cta-diana-independiente-v7', nombre:'Diana captación inteligente', tipo:'Asesor independiente', estado:'Activo', ciudad:'Cuernavaca', responsable:'Diana Salgado', director:'', whatsappDirector:'', emailDirector:'', logo:'CASITA_METODO_NERI', limiteAsesores:1, plan:'Independiente · 1 asesor', notas:'Ejemplo independiente. Sin logo inmobiliaria; usa casita Método NERI.' }
    ],
    usuarios:[
      { id:'usr-c21-director-v7', cuentaId:'cta-c21-haus-v7', nombre:'Director pendiente', whatsapp:'', email:'', foto:'', frase:'', ciudad:'Cuernavaca', pixel:'', tipo:'Inmobiliaria', estado:'Activo', puesto:'Director', slugSugerido:'director-pendiente', slugOficial:'director-pendiente', permisos:[...ADMIN_DEFAULT_PERMS_ORG] },
      { id:'usr-diana-v7', cuentaId:'cta-diana-independiente-v7', nombre:'Diana Salgado', whatsapp:'', email:'', foto:'', frase:'Te ayudo a preparar tu venta con orden.', ciudad:'Cuernavaca', pixel:'', tipo:'Asesor independiente', estado:'Activo', puesto:'Asesor independiente', slugSugerido:'diana-salgado', slugOficial:'diana-salgado', permisos:[...ADMIN_DEFAULT_PERMS_INDEPENDIENTE] }
    ]
  };
}
function adminLoad(){
  try{
    const raw = localStorage.getItem(ADMIN_V7_STORAGE_KEY);
    adminState.data = raw ? JSON.parse(raw) : adminSeedData();
  }catch(e){ adminState.data = adminSeedData(); }
  adminV7Normalize();
  if(!adminState.tab || ['cuentas','usuarios'].includes(adminState.tab)) adminState.tab='dashboard';
...
function adminSave(show=true){
  adminV7Normalize();
  localStorage.setItem(ADMIN_V7_STORAGE_KEY, JSON.stringify(adminState.data));
  if(show) showToast('✓ Administración guardada');
}
function adminV7Normalize(){
  ...
  adminState.data.cuentas.forEach(c=>{
    if(c.tipo === 'Inmobiliaria'){
      const plan = ADMIN_V7_PLANES_INMOBILIARIA.find(p=>p.limite===Number(c.limiteAsesores)) || ADMIN_V7_PLANES_INMOBILIARIA[0];
      c.limiteAsesores = plan.limite;
      c.plan = c.plan || plan.value;
    }
    if(c.tipo === 'Grupo de asesores sin inmobiliaria'){
      c.limiteAsesores = 5;
      c.plan = c.plan || ADMIN_V7_PLANES.grupo;
    }
    if(c.tipo === 'Asesor independiente'){
      c.limiteAsesores = 1;
      c.logo = 'CASITA_METODO_NERI';
      c.plan = c.plan || ADMIN_V7_PLANES.independiente;
    }
    c.responsable = c.responsable || '';
    c.director = c.director || '';
    c.whatsappDirector = c.whatsappDirector || '';
    c.emailDirector = c.emailDirector || '';
...
function adminApplyBusinessRules(){
  ...
  d.usuarios.forEach(u=>{
    ...
    if(c){
      u.tipo = c.tipo;
      if(!u.estado) u.estado = c.estado || 'Pendiente';
      if(c.tipo === 'Asesor independiente'){
        u.puesto = 'Asesor independiente';
        u.permisos = Array.isArray(u.permisos) && u.permisos.length ? u.permisos : [...ADMIN_DEFAULT_PERMS_INDEPENDIENTE];
        u.permisos = u.permisos.filter(p=>p !== 'branding_cuenta');
...
function adminCuentaMaxUsers(c){
  if(!c) return 0;
  if(c.tipo === 'Inmobiliaria') return [10,15,20,30].includes(Number(c.limiteAsesores)) ? Number(c.limiteAsesores) : 10;
  if(c.tipo === 'Grupo de asesores sin inmobiliaria') return 5;
  return 1;
}
function adminCuentaUsage(c){
  if(!c) return 0;
  if(c.tipo === 'Asesor independiente') return adminCuentaUsers(c.id).length ? 1 : 0;
  return adminCuentaUsers(c.id).filter(u=>u.puesto === 'Asesor').length;
}
function adminCanAddUser(c){ return adminCuentaUsage(c) < adminCuentaMaxUsers(c); }
function adminV7ActiveCuentas(tipo){ return adminState.data.cuentas.filter(c=>c.tipo===tipo && c.estado==='Activo').length; }
function adminV7ActiveUsers(){ return adminState.data.usuarios.filter(u=>u.estado==='Activo').length; }
function adminV7TypeLabel(tipo){
  if(tipo === 'Inmobiliaria') return 'Inmobiliarias';
  if(tipo === 'Asesor independiente') return 'Independientes';
  return 'Grupos sin inmobiliaria';
}
function adminV7TypeEmpty(tipo){
  if(tipo === 'Grupo de asesores sin inmobiliaria') return 'Aún no tienes grupos registrados. Cuando des de alta un grupo, aparecerá aquí.';
  if(tipo === 'Asesor independiente') return 'Aún no tienes asesores independientes registrados. Cuando crees una intranet independiente, aparecerá aquí.';
  return 'Aún no tienes inmobiliarias registradas. Cuando crees una intranet de inmobiliaria, aparecerá aquí.';
}
function adminV7PlanLabel(c){
  if(!c) return 'Sin paquete';
  if(c.tipo === 'Inmobiliaria') return c.plan || `Inmobiliaria · ${adminCuentaMaxUsers(c)} asesores`;
  if(c.tipo === 'Grupo de asesores sin inmobiliaria') return ADMIN_V7_PLANES.grupo;
  return ADMIN_V7_PLANES.independiente;
}
function adminV7PlanFromLimit(limit){
  const p = ADMIN_V7_PLANES_INMOBILIARIA.find(x=>x.limite===Number(limit)) || ADMIN_V7_PLANES_INMOBILIARIA[0];
  return p.value;
}
function adminV7NavButton(id,label){ return `<button id="admin-v7-nav-${id}" onclick="adminSetView('${id}')">${label}</button>`; }
function buildAdministracionPanel(){
  return `<div class="panel" id="panel-administracion">
    ${adminV7Css()}
    <div class="admin-base-body admin-v7-body">
      <div class="admin-v7-wrap">
        <div class="admin-v7-hero">
          <div class="admin-v7-top">
            <div>
              <div class="ph-eyebrow">Administración Método NERI</div>
              <div class="admin-v7-title">PANEL <em>EJECUTIVO</em></div>
              <div class="admin-v7-sub">Control de intranets activas, cuentas, paquetes, usuarios y soporte. Este panel no muestra CRM, leads, clientes, propiedades, citas, mensajes ni expedientes.</div>
            </div>
            <button class="admin-v7-create" onclick="adminGoCrear()">+ Crear nueva intranet</button>
          </div>
          <div class="admin-v7-kpis" id="admin-v7-kpis"></div>
          <div class="admin-v7-alerts" id="admin-v7-alerts"></div>
        </div>
        <div class="admin-v7-nav">
          ${adminV7NavButton('dashboard','Inicio')}
          ${adminV7NavButton('inmobiliarias','Inmobiliarias')}
          ${adminV7NavButton('independientes','Independientes')}
          ${adminV7NavButton('grupos','Grupos sin inmobiliaria')}
          ${adminV7NavButton('permisos','Permisos')}
          <button class="admin-v7-reset" onclick="adminV7ResetDemo()">Reiniciar prueba</button>
        </div>
        <div id="admin-content"></div>
      </div>
    </div>
...
function adminGoCrear(tipo=''){
  adminState.tab = 'crear';
  adminState.createTipo = tipo || '';
  adminRender();
}
function adminRender(){
  if(!adminState.data) adminLoad();
  adminV7Normalize();
  const allowed = ['dashboard','inmobiliarias','independientes','grupos','cuenta','crear','permisos'];
  if(!allowed.includes(adminState.tab)) adminState.tab = 'dashboard';
  document.querySelectorAll('.admin-v7-nav button').forEach(b=>b.classList.remove('active'));
  const activeMap = { cuenta: adminV7TabForCuenta(adminCuenta(adminState.selectedCuentaId)), crear:'dashboard' };
  const navId = activeMap[adminState.tab] || adminState.tab;
  document.getElementById('admin-v7-nav-'+navId)?.classList.add('active');
  adminRenderKpis();
  ...
  if(adminState.tab==='permisos') el.innerHTML = adminRenderPermisosV7();
}
function adminV7TabForCuenta(c){
  if(!c) return 'dashboard';
  if(c.tipo==='Inmobiliaria') return 'inmobiliarias';
  if(c.tipo==='Asesor independiente') return 'independientes';
  return 'grupos';
}
function adminRenderKpis(){
  const d = adminState.data || {cuentas:[],usuarios:[]};
  const kpis = [
    ['Inmobiliarias activas', adminV7ActiveCuentas('Inmobiliaria')],
    ['Asesores independientes activos', adminV7ActiveCuentas('Asesor independiente')],
    ['Grupos activos', adminV7ActiveCuentas('Grupo de asesores sin inmobiliaria')],
    ['Usuarios activos totales', adminV7ActiveUsers()],
  ];
  const el = document.getElementById('admin-v7-kpis'); if(el) el.innerHTML = kpis.map(k=>`<div class="admin-v7-kpi"><div class="admin-v7-kpi-num">${k[1]}</div><div class="admin-v7-kpi-lbl">${k[0]}</div></div>`).join('');
  const pendientes = d.cuentas.filter(c=>c.estado==='Pendiente').length;
  const inactivas = d.cuentas.filter(c=>c.estado==='Inactivo').length;
  const alerts = [];
  if(pendientes) alerts.push(`<div class="admin-v7-alert">${pendientes} cuenta${pendientes===1?'':'s'} pendiente${pendientes===1?'':'s'} por resolver</div>`);
  if(inactivas) alerts.push(`<div class="admin-v7-alert red">${inactivas} cuenta${inactivas===1?'':'s'} inactiva${inactivas===1?'':'s'}</div>`);
  const ae = document.getElementById('admin-v7-alerts'); if(ae) ae.innerHTML = alerts.join('');
}
function adminRenderDashboard(){
  return `<div class="admin-v7-section">
    <div class="admin-v7-sec-head"><div><div class="admin-v7-sec-title">DIRECTORIOS <em>SEPARADOS</em></div><div class="admin-v7-sec-sub">Cada tipo vive en su lugar. Nada mezclado.</div></div></div>
    <div class="admin-v7-directory-grid">
      <div class="admin-v7-dir-card" onclick="adminSetView('inmobiliarias')"><div class="num">${adminState.data.cuentas.filter(c=>c.tipo==='Inmobiliaria').length}</div><div class="name">Inmobiliarias</div><div class="desc">Entrar, seleccionar cuenta, revisar cupo, usuarios, permisos, logo, soporte y estado.</div></div>
      <div class="admin-v7-dir-card" onclick="adminSetView('independientes')"><div class="num">${adminState.data.cuentas.filter(c=>c.tipo==='Asesor independiente').length}</div><div class="name">Asesores independientes</div><div class="desc">Cuentas individuales con casita Método NERI, perfil público y link de captación automático.</div></div>
      <div class="admin-v7-dir-card" onclick="adminSetView('grupos')"><div class="num">${adminState.data.cuentas.filter(c=>c.tipo==='Grupo de asesores sin inmobiliaria').length}</div><div class="name">Grupos sin inmobiliaria</div><div class="desc">Cuenta chica con cupo fijo de 5 asesores, sin lenguaje de inmobiliaria.</div></div>
    </div>
  </div>
  <div class="admin-v7-section">
    <div class="admin-v7-sec-head"><div><div class="admin-v7-sec-title">PAQUETES <em>PREPARADOS</em></div><div class="admin-v7-sec-sub">No es reporte de ingresos; es recordatorio comercial de lo que se vende.</div></div></div>
    <div class="admin-v7-packages">
      <div class="admin-v7-package"><b>Independiente</b><span>Para un asesor con una sola cuenta, casita Método NERI y link de captación automático.</span><small>1 asesor</small></div>
      <div class="admin-v7-package"><b>Grupo sin inmobiliaria</b><span>Para equipos chicos que no quieren estructura de inmobiliaria.</span><small>5 asesores</small></div>
      <div class="admin-v7-package"><b>Inmobiliaria</b><span>Cuenta madre con logo, director, gerente, asesores, permisos y soporte por cuenta.</span><small>10 · 15 · 20 · 30 asesores</small></div>
    </div>
  </div>
  <div class="admin-v7-section">
    <div class="admin-v7-sec-head"><div><div class="admin-v7-sec-title">RUTA PARA <em>RESOLVER</em></div><div class="admin-v7-sec-sub">Cuando alguien llame con un problema técnico.</div></div></div>
    <div class="admin-v7-support-grid">
      <div class="admin-v7-support"><b>1. Ir al directorio correcto</b>Inmobiliaria, independiente o grupo. No buscar entre cuentas mezcladas.</div>
      <div class="admin-v7-support"><b>2. Seleccionar la cuenta</b>Abre la ficha completa con estado, paquete, branding, usuarios y permisos.</div>
      <div class="admin-v7-support"><b>3. Resolver desde la ficha</b>Activar/desactivar, revisar cupo, copiar link, ver permisos o dar soporte.</div>
    </div>
  </div>`;
}
function adminRenderDirectory(tipo){
  const cuentas = adminState.data.cuentas.filter(c=>c.tipo===tipo);
  const title = adminV7TypeLabel(tipo);
  const desc = tipo==='Inmobiliaria' ? 'Solo cuentas inmobiliarias. Aquí no aparecen independientes ni grupos.' : tipo==='Asesor independiente' ? 'Solo cuentas individuales de asesor independiente.' : 'Solo grupos chicos sin inmobiliaria. Si no tienes grupos, queda vacío.';
  const list = cuentas.length ? `<div class="admin-v7-list">${cuentas.map(c=>adminAccountCard(c)).join('')}</div>` : `<div class="admin-v7-empty"><b>Sin registros</b>${adminEsc(adminV7TypeEmpty(tipo))}</div>`;
  return `<div class="admin-v7-section"><div class="admin-v7-sec-head"><div><div class="admin-v7-sec-title">${adminEsc(title).toUpperCase()} <em>ACTIVAS</em></div><div class="admin-v7-sec-sub">${adminEsc(desc)}</div></div><button class="admin-v7-create" onclick="adminGoCrear()">+ Crear nueva intranet</button></div>${list}</div>`;
}
function adminAccountCard(c){
  const users = adminCuentaUsers(c.id);
  const activeUsers = users.filter(u=>u.estado==='Activo').length;
  const usage = adminCuentaUsage(c);
  const limit = adminCuentaMaxUsers(c);
  const detail = c.tipo === 'Asesor independiente'
    ? `Usuario: ${activeUsers}/1 · ${adminLink(users[0]||{} )}`
    : `Asesores: ${usage}/${limit} · Usuarios totales: ${users.length}`;
  return `<div class="admin-v7-account-card" onclick="adminOpenCuenta('${c.id}')">
    <div class="ar-top"><div><div class="admin-v7-account-name">${adminEsc(c.nombre)}</div><div class="admin-v7-account-meta">${adminEsc(c.ciudad||'Sin ciudad')} · ${adminEsc(adminV7PlanLabel(c))}<br>${adminEsc(detail)}</div></div>${adminBadge(c.estado)}</div>
    <div class="admin-v7-account-actions"><span class="admin-v7-resolver">Ver / resolver →</span><span class="ar-meta">Responsable: ${adminEsc(c.responsable||'Pendiente')}</span></div>
  </div>`;
}
function adminOpenCuenta(id){
  adminState.selectedCuentaId = id;
  const first = adminCuentaUsers(id)[0];
  adminState.selectedUsuarioId = first?.id || null;
  adminState.tab = 'cuenta';
  adminRender();
}
function adminRenderCuentaDetalle(){
  const c = adminCuenta(adminState.selectedCuentaId);
  if(!c) return `<div class="admin-v7-empty"><b>Sin cuenta seleccionada</b>Selecciona una cuenta desde su directorio.</div>`;
  const users = adminCuentaUsers(c.id);
  const usage = adminCuentaUsage(c), limit = adminCuentaMaxUsers(c);
  const selectedUser = adminUsuario(adminState.selectedUsuarioId);
  const canAdd = adminCanAddUser(c);
  const userForm = selectedUser ? `<div class="admin-v7-card"><div class="admin-v7-card-head"><div><div class="admin-v7-card-title">EDITAR <em>PERFIL</em></div><div class="admin-card-sub">Solo datos públicos del usuario</div></div></div><div class="admin-v7-card-body">${adminUsuarioForm(selectedUser)}</div></div>` : '';
  return `<div class="admin-v7-sec-head"><div><div class="admin-v7-sec-title">${adminEsc(c.nombre)} <em>· resolver</em></div><div class="admin-v7-sec-sub">Ficha completa de cuenta. Aquí está todo lo necesario para soporte.</div></div><button class="admin-v7-create" onclick="adminSetView('${adminV7TabForCuenta(c)}')">← Volver al directorio</button></div>
  <div class="admin-v7-detail-grid">
    <div class="admin-v7-side">
      <div class="admin-v7-card"><div class="admin-v7-card-head"><div><div class="admin-v7-card-title">ESTADO DE <em>CUENTA</em></div><div class="admin-card-sub">Activación y paquete</div></div>${adminBadge(c.estado)}</div><div class="admin-v7-card-body">
        <div class="admin-v7-mini-grid">
          <div class="admin-v7-mini"><kbd>Tipo</kbd><strong>${adminEsc(adminTipoCorto(c.tipo))}</strong></div>
          <div class="admin-v7-mini"><kbd>Paquete</kbd><strong>${adminEsc(adminV7PlanLabel(c))}</strong></div>
          <div class="admin-v7-mini"><kbd>Asesores usados</kbd><strong class="gold">${usage} / ${limit}</strong></div>
          <div class="admin-v7-mini"><kbd>Usuarios totales</kbd><strong>${users.length}</strong></div>
        </div>
      </div></div>
      <div class="admin-v7-card"><div class="admin-v7-card-head"><div><div class="admin-v7-card-title">DATOS <em>ADMIN</em></div><div class="admin-card-sub">Solo administración edita</div></div></div><div class="admin-v7-card-body">${adminCuentaFormV7(c)}</div></div>
    </div>
    <div class="admin-v7-side">
      <div class="admin-v7-card"><div class="admin-v7-card-head"><div><div class="admin-v7-card-title">USUARIOS / <em>SUBCUENTAS</em></div><div class="admin-card-sub">Director, gerente y asesores de esta cuenta</div></div>${c.tipo==='Asesor independiente'?'':`<button class="btn btn-primary" onclick="adminV7AddUserPrompt('${c.id}')" ${!canAdd?'disabled':''}>+ Preparar asesor</button>`}</div><div class="admin-v7-card-body">
        ${!canAdd && c.tipo!=='Asesor independiente' ? `<div class="admin-v7-form-note">Cupo lleno. Esta cuenta tiene ${usage} de ${limit} asesores autorizados.</div>` : ''}
        ${adminUsuariosCuentaListV7(c)}
      </div></div>
      <div class="admin-v7-card"><div class="admin-v7-card-head"><div><div class="admin-v7-card-title">CENTRO DE <em>SOPORTE</em></div><div class="admin-card-sub">Acciones rápidas de resolución</div></div></div><div class="admin-v7-card-body"><div class="admin-v7-support-grid">
        <div class="admin-v7-support"><b>Permisos</b>Selecciona un usuario y revisa qué puede usar.</div>
        <div class="admin-v7-support"><b>Branding</b>${c.tipo==='Asesor independiente'?'Casita Método NERI automática.':'Logo controlado desde esta ficha.'}</div>
        <div class="admin-v7-support"><b>Link Captación</b>En cada usuario puedes copiar o revisar el link generado.</div>
      </div></div></div>
      ${userForm}
    </div>
  </div>`;
}
function adminCuentaFormV7(c){
  const isInd = c.tipo === 'Asesor independiente';
  const isInmo = c.tipo === 'Inmobiliaria';
  const planSelect = isInmo ? adminSelectObjects('Paquete / cupo contratado','cuenta-limite-v7',String(adminCuentaMaxUsers(c)),ADMIN_V7_PLANES_INMOBILIARIA.map(p=>({value:String(p.limite),label:p.label}))) : `<div class="form-group"><label>Paquete</label><input class="form-inp" value="${adminEsc(adminV7PlanLabel(c))}" disabled></div>`;
  const logoField = isInd ? `<div class="form-group full"><div class="admin-v7-form-note"><b>Asesor independiente:</b> no carga logo inmobiliaria. Usa casita Método NERI automática.</div></div>` : `<div class="form-group full">${adminUploadField(isInmo?'Logo inmobiliaria':'Logo de grupo / cuenta','cuenta-logo-v7',c.logo,'Sube logo como archivo. No se pega URL.')}</div>`;
  return `<div class="admin-form-grid">
    <div class="form-group"><label>Tipo</label><input class="form-inp" value="${adminEsc(c.tipo)}" disabled></div>
    ${adminSelect('Estado / activación','cuenta-estado-v7',c.estado,['Pendiente','Activo','Inactivo'])}
    ${adminField('Nombre de cuenta','cuenta-nombre-v7',c.nombre)}
    ${adminField('Ciudad','cuenta-ciudad-v7',c.ciudad)}
    ${adminField('Responsable administrativo','cuenta-responsable-v7',c.responsable)}
    ${planSelect}
    ${isInd ? '' : adminField('Director / líder','cuenta-director-v7',c.director||'')}
    ${isInd ? '' : adminField('WhatsApp director / líder','cuenta-whatsapp-director-v7',c.whatsappDirector||'')}
    ${isInd ? '' : adminField('Email director / líder','cuenta-email-director-v7',c.emailDirector||'')}
    ${logoField}
    ${adminArea('Notas administrativas','cuenta-notas-v7',c.notas,'full')}
  </div><div class="admin-actions"><button class="btn btn-ghost" onclick="adminDeleteCuentaV7('${c.id}')">Eliminar cuenta</button><button class="btn btn-primary" onclick="adminSaveCuentaV7('${c.id}')">Guardar cuenta</button></div>`;
}
function adminUsuariosCuentaListV7(c){
  const users = adminCuentaUsers(c.id);
  if(!users.length) return `<div class="admin-v7-empty"><b>Sin usuarios</b>Esta cuenta aún no tiene perfiles preparados.</div>`;
  return `<div class="admin-v7-users">${users.map(u=>`<div class="admin-v7-user-row"><div><div class="admin-v7-user-name">${adminEsc(u.nombre)}</div><div class="admin-v7-user-meta">${adminEsc(u.puesto||'Sin puesto')} · ${adminEsc(u.email||'Sin email')} · ${adminLink(u)}</div></div><div class="admin-v7-user-actions">${adminBadge(u.estado)}<button class="admin-v7-smallbtn" onclick="adminOpenUsuarioV7('${u.id}')">Editar</button><button class="admin-v7-smallbtn" onclick="adminV7CopyUserLink('${u.id}')">Copiar link</button><button class="admin-v7-smallbtn" onclick="adminV7ToggleUser('${u.id}')">${u.estado==='Inactivo'?'Activar':'Desactivar'}</button><button class="admin-v7-smallbtn red" onclick="adminV7DeleteUser('${u.id}')">Baja</button></div></div>`).join('')}</div>`;
}
function adminOpenUsuarioV7(id){ adminState.selectedUsuarioId = id; adminRender(); }
function adminSaveCuentaV7(id){
  const c = adminCuenta(id); if(!c) return;
  c.estado = val('cuenta-estado-v7');
  c.nombre = val('cuenta-nombre-v7');
  c.ciudad = val('cuenta-ciudad-v7');
  c.responsable = val('cuenta-responsable-v7');
  c.director = val('cuenta-director-v7');
  c.whatsappDirector = val('cuenta-whatsapp-director-v7').replace(/\D/g,'');
  c.emailDirector = val('cuenta-email-director-v7');
  c.notas = val('cuenta-notas-v7');
  if(c.tipo === 'Inmobiliaria'){
    c.limiteAsesores = Number(val('cuenta-limite-v7')||10);
    c.plan = adminV7PlanFromLimit(c.limiteAsesores);
    c.logo = val('cuenta-logo-v7');
  }else if(c.tipo === 'Grupo de asesores sin inmobiliaria'){
    c.limiteAsesores = 5; c.plan = ADMIN_V7_PLANES.grupo; c.logo = val('cuenta-logo-v7');
  }else{
    c.limiteAsesores = 1; c.plan = ADMIN_V7_PLANES.independiente; c.logo = 'CASITA_METODO_NERI'; adminEnsureUserForCuenta(c,false);
  }
  adminCuentaUsers(c.id).forEach(u=>{ if(!u.estado) u.estado = c.estado; u.tipo = c.tipo; });
  adminSave(); adminRender();
}
function adminDeleteCuentaV7(id){
  const c = adminCuenta(id); if(!c) return;
  if(adminCuentaUsers(id).length){ showToast('No se elimina: primero da de baja o elimina sus usuarios'); return; }
  adminState.data.cuentas = adminState.data.cuentas.filter(x=>x.id!==id);
  adminState.selectedCuentaId = null;
  adminSave(); adminSetView(adminV7TabForCuenta(c));
}
function adminV7AddUserPrompt(cuentaId){
  const c = adminCuenta(cuentaId); if(!c) return;
  if(!adminCanAddUser(c)){ showToast('Cupo lleno: no se pueden preparar más asesores'); return; }
  adminAddUserToCuenta(cuentaId,'Asesor');
  adminState.tab='cuenta';
}
function adminV7ToggleUser(id){
  const u = adminUsuario(id); if(!u) return;
  u.estado = u.estado === 'Inactivo' ? 'Activo' : 'Inactivo';
  adminSave(); adminRender();
}
function adminV7DeleteUser(id){
  const u = adminUsuario(id); if(!u) return;
  const c = adminCuenta(u.cuentaId);
  if(c?.tipo === 'Asesor independiente'){ showToast('La cuenta independiente requiere su perfil único'); return; }
  adminState.data.usuarios = adminState.data.usuarios.filter(x=>x.id!==id);
  adminState.selectedUsuarioId = adminCuentaUsers(c?.id || '')[0]?.id || null;
  adminSave(); adminRender();
}
function adminV7CopyUserLink(id){
  const u = adminUsuario(id); if(!u || !u.slugOficial){ showToast('Aún no hay link generado'); return; }
  navigator.clipboard?.writeText(adminLink(u));
  showToast('Link Captación copiado');
}
function adminRenderCrear(){
  ...
  if(!tipo){
    return `<div class="admin-v7-section"><div class="admin-v7-sec-head"><div><div class="admin-v7-sec-title">CREAR NUEVA <em>INTRANET</em></div><div class="admin-v7-sec-sub">Un solo camino de creación. Primero el tipo, después el formulario correcto.</div></div></div><div class="admin-v7-create-types">
      <div class="admin-v7-type-card" onclick="adminGoCrear('Inmobiliaria')"><div class="icon">▦</div><b>Inmobiliaria</b><p>Cuenta madre con logo, director, gerente, asesores y cupo 10/15/20/30.</p></div>
      <div class="admin-v7-type-card" onclick="adminGoCrear('Asesor independiente')"><div class="icon">⌂</div><b>Asesor independiente</b><p>Cuenta individual con casita Método NERI, perfil público y link automático.</p></div>
      <div class="admin-v7-type-card" onclick="adminGoCrear('Grupo de asesores sin inmobiliaria')"><div class="icon">◌</div><b>Grupo sin inmobiliaria</b><p>Cuenta chica para máximo 5 asesores, sin lenguaje corporativo de inmobiliaria.</p></div>
    </div></div>`;
  }
  const isInmo = tipo === 'Inmobiliaria', isInd = tipo === 'Asesor independiente', isGroup = tipo === 'Grupo de asesores sin inmobiliaria';
  const plan = isInmo ? adminSelectObjects('Paquete / cupo contratado','new-limite','10',ADMIN_V7_PLANES_INMOBILIARIA.map(p=>({value:String(p.limite),label:p.label}))) : `<div class="form-group"><label>Paquete</label><input class="form-inp" value="${adminEsc(isGroup?ADMIN_V7_PLANES.grupo:ADMIN_V7_PLANES.independiente)}" disabled></div>`;
  const logo = isInd ? `<div class="form-group full"><div class="admin-v7-form-note"><b>Asesor independiente:</b> usa casita Método NERI automática. No se carga logo inmobiliaria.</div></div>` : `<div class="form-group full">${adminUploadField(isInmo?'Logo inmobiliaria':'Logo de grupo','new-logo','','Sube logo como archivo. No se pega URL.')}</div>`;
  ...
  return `<div class="admin-v7-section"><div class="admin-v7-sec-head"><div><div class="admin-v7-sec-title">NUEVA INTRANET · <em>${adminEsc(adminTipoCorto(tipo))}</em></div><div class="admin-v7-sec-sub">Creación controlada por administración</div></div><button class="admin-v7-create" onclick="adminGoCrear()">Cambiar tipo</button></div>
  <div class="admin-v7-card"><div class="admin-v7-card-body"><div class="admin-v7-form-note">Al guardar, la cuenta se va automáticamente a su directorio: inmobiliaria, independiente o grupo. La activación se controla desde Estado.</div><div class="admin-form-grid">
  ...
  </div><div class="admin-actions"><button class="btn btn-ghost" onclick="adminGoCrear()">Cancelar</button><button class="btn btn-primary" onclick="adminCreateCuentaV7()">Crear intranet</button></div></div></div></div>`;
}
function adminCreateCuentaV7(){
  const tipo = adminState.createTipo;
  if(!ADMIN_TIPOS_CUENTA.includes(tipo)){ showToast('Selecciona tipo de cuenta'); return; }
  ...
  if(tipo === 'Inmobiliaria'){ c.limiteAsesores = Number(val('new-limite')||10); c.plan = adminV7PlanFromLimit(c.limiteAsesores); c.logo = val('new-logo'); }
  if(tipo === 'Grupo de asesores sin inmobiliaria'){ c.limiteAsesores = 5; c.plan = ADMIN_V7_PLANES.grupo; c.logo = val('new-logo'); }
  if(tipo === 'Asesor independiente'){ c.limiteAsesores = 1; c.plan = ADMIN_V7_PLANES.independiente; c.logo = 'CASITA_METODO_NERI'; }
  adminState.data.cuentas.unshift(c);
  if(tipo === 'Asesor independiente'){
    const slug = adminUniqueSlug(adminSlug(nombre), null);
    adminState.data.usuarios.unshift({ id:adminId('usr'), cuentaId:c.id, nombre:nombre, whatsapp:val('new-whatsapp').replace(/\D/g,''), email:val('new-email'), foto:val('new-foto'), frase:val('new-frase'), ciudad:c.ciudad, pixel:val('new-pixel'), tipo, estado:c.estado, puesto:'Asesor independiente', slugSugerido:slug, slugOficial:slug, permisos:[...ADMIN_DEFAULT_PERMS_INDEPENDIENTE] });
  }else if(c.director){
    const slug = adminUniqueSlug(adminSlug(c.director), null);
    adminState.data.usuarios.unshift({ id:adminId('usr'), cuentaId:c.id, nombre:c.director, whatsapp:c.whatsappDirector, email:c.emailDirector, foto:'', frase:'', ciudad:c.ciudad, pixel:'', tipo, estado:c.estado, puesto:tipo==='Inmobiliaria'?'Director':'Líder de grupo', slugSugerido:slug, slugOficial:slug, permisos:[...ADMIN_DEFAULT_PERMS_ORG] });
  }
  adminState.selectedCuentaId = c.id;
  adminState.selectedUsuarioId = adminCuentaUsers(c.id)[0]?.id || null;
  adminState.tab='cuenta';
  adminSave(); adminRender();
}
function adminRenderPermisosV7(){
  const d=adminState.data;
  const selected = adminUsuario(adminState.selectedUsuarioId) || d.usuarios[0] || null;
  if(selected) adminState.selectedUsuarioId = selected.id;
  const grouped = ADMIN_TIPOS_CUENTA.map(tipo=>{
    const users = d.usuarios.filter(u=>u.tipo===tipo);
    if(!users.length) return '';
    return `<div class="admin-card-sub" style="margin:12px 0 6px;color:var(--gold)">${adminEsc(adminV7TypeLabel(tipo))}</div>` + users.map(u=>`<div class="admin-row ${u.id===adminState.selectedUsuarioId?'active':''}" onclick="adminSelectUsuario('${u.id}')"><div class="ar-top"><div><div class="ar-name">${adminEsc(u.nombre)}</div><div class="ar-meta">${adminEsc(adminCuentaName(u.cuentaId))}</div></div>${adminBadge(u.estado)}</div><div class="ar-meta">${u.permisos.length} permisos · ${adminEsc(u.puesto||'Sin puesto')}</div></div>`).join('');
  }).join('');
  const checks = selected ? ADMIN_PERMISSION_CATALOG.map(p=>{
    const blockedBranding = selected.tipo === 'Asesor independiente' && p.id === 'branding_cuenta';
    return `<label class="admin-check ${blockedBranding?'disabled':''}"><input type="checkbox" data-perm="${p.id}" ${selected.permisos.includes(p.id)&&!blockedBranding?'checked':''} ${blockedBranding?'disabled':''}><div><b>${adminEsc(p.title)}</b><span>${adminEsc(p.desc)}</span>${blockedBranding?'<small>No aplica para asesor independiente. Se usa casita Método NERI automática.</small>':''}</div></label>`;
  }).join('') : '';
  const form = selected ? `<div class="admin-v7-form-note">Permisos base para ${adminEsc(selected.nombre)}. En esta prueba todavía no bloquean navegación; quedan listos para login real.</div><div class="admin-checks">${checks}</div><div class="admin-actions"><button class="btn btn-primary" onclick="adminSavePermisos()">Guardar permisos</button></div>` : `<div class="admin-v7-empty"><b>Sin usuarios</b>Crea primero una intranet.</div>`;
  return `<div class="admin-grid"><div class="admin-card"><div class="admin-card-head"><div><div class="admin-card-title">USUARIOS PARA <em>PERMISOS</em></div><div class="admin-card-sub">Separados por tipo de cuenta</div></div></div><div class="admin-card-body"><div class="admin-list">${grouped}</div></div></div><div class="admin-card"><div class="admin-card-head"><div><div class="admin-card-title">PERMISOS <em>BASE</em></div><div class="admin-card-sub">Preparado para etapa real</div></div></div><div class="admin-card-body">${form}</div></div></div>`;
}
function adminSelectUsuario(id){ adminState.selectedUsuarioId=id; adminRender(); }
function adminNewUsuario(){
  const c = adminCuenta(adminState.selectedCuentaId);
  if(!c){ showToast('Primero selecciona una cuenta'); return; }
  if(c.tipo === 'Asesor independiente'){ adminEnsureUserForCuenta(c); adminSave(); adminRender(); return; }
  adminV7AddUserPrompt(c.id);
}
function adminV7ResetDemo(){
  localStorage.removeItem(ADMIN_V7_STORAGE_KEY);
  adminState.data = adminSeedData();
  adminState.tab='dashboard'; adminState.selectedCuentaId=null; adminState.selectedUsuarioId=null; adminState.createTipo='';
  adminSave(false); adminRender(); showToast('Prueba reiniciada');
}
